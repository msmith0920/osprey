...
class TestRegistryReset:
    ...
    def test_reset_clears_initialized_flag(self, registry_temp_config):
        """Verify reset_registry() clears the _initialized flag."""
        # Initialize registry
        reset_registry()
        initialize_registry(config_path=registry_temp_config)
        ...
        reset_registry()
        registry = get_registry(config_path=registry_temp_config)
    ...
    def test_reset_allows_reinitialization(self, registry_temp_config):
    ...
    def test_multiple_resets_in_sequence(self, registry_temp_config):
    ...
    def test_initialize_is_idempotent(self, registry_temp_config):
...
class TestRegistryIsolation:
    ...
    def test_config_cache_cleared_on_reset(self, registry_temp_config):
    ...
    def test_approval_manager_reset(self, registry_temp_config):
    ...
    def test_env_var_isolation(self, registry_temp_config):
        """Verify CONFIG_FILE env var doesn't pollute between tests."""
        # Set CONFIG_FILE
        os.environ["CONFIG_FILE"] = registry_temp_config
    ...
    def test_sys_modules_cleanup(self, registry_temp_config):
...
class TestRegistryStateAfterBenchmark:
    ...
    def test_simulated_benchmark_cleanup(self, registry_temp_config):
