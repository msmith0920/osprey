...
class ChannelValueRetrievalCapability(BaseCapability):
    ...
    def _create_orchestrator_guide(self) -> Optional[OrchestratorGuide]:
        """Create orchestrator guide for channel value retrieval planning."""
